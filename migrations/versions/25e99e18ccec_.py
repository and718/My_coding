...
Revision ID: 25e99e18ccec
Revises: ade964192594
Create Date: 2020-06-10 16:44:02.935894
...
revision = '25e99e18ccec'
down_revision = 'ade964192594'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('craete_time', sa.DateTime(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['uid'], ['t_table.id'], ),
