...
from flask_shop.until.tokens import generate_auth_token,verify_auth_token,login_required
@user.route('/')
def index():
    return "User Hello!!!"
...
class UserList(Resource):
    def get(self):
        ...
        try:
            ...
            name = args.get('name')
            pnum = args.get('pnum') if args.get('pum') else 1
